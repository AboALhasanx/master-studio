...
> **Student:** 1st Year Master of Computer Science  
...
## 1. Executive Mastery Radar (Semester 1)

```
+-----------------------------------------------------------------------------------------------+
|                               SEMESTER 1 SUBJECT MASTERY RADAR                                |
+-----------------------------------------------------------------------------------------------+
...
Every interactive quiz taken via `quiz_runner.py` or logged from mobile chatbots is permanently recorded here:

| Log ID | Date & Time | Subject | Topic / Source | Score | Result | Status |
|:---:|:---:|:---|:---|:---:|:---:|:---:|
