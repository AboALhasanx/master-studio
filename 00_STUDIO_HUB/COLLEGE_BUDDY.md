...
| **EVT-05** | after Unit 1 from **both** sources (no date stated) | 02_English_Language | **Exam after Unit 1** (Q Skills + Headway) + **research-paper talk next week** on Data Show | Dr. Haidar Akab Alwan | UPCOMING | MEDIUM | Student report 2026-09-20: not only a 5-min presentation — she wants them to **read a formal research paper** and **speak about it on the Data Show**; she will **ask about academic English word meanings**. Topic field still computer/software per earlier report. |
