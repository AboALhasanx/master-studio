---
title: "ASE Week 02 — Unit 09: Choosing a Model"
subtitle: "No model wins outright — the three factors that drive selection, the two drivers that dominate, and why the final documentation always reads like waterfall"
subject: "04_Advanced_Software_Eng"
week: 2
sources:
  - "Mall, Fundamentals of Software Engineering, 4th ed., §2.6–§2.6.1, pp.118–121"
  - "Sommerville, Software Engineering, 9th ed., p.46"
...
![Model selection: the three factors, the situation-to-model guide, and the documentation trap|720](../06_Diagrams_&_Mindmaps/model_selection_guide.png)
