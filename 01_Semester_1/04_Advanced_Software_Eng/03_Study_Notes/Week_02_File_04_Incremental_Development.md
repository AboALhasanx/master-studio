---
title: "ASE Week 02 — Unit 04: Incremental Development"
...
**الاسم الثاني:** النموذج يُسمّى أحياناً **successive versions model** وأحياناً **incremental model** — **تسميتان لنفس النموذج**. (وهذا مثل `exploratory / build and fix / code and fix` بالملف 02 — نمط متكرر عند Mall.)
...
![Incremental development: specification, development and validation interleaved across four increments, with the benefits, the management problems, and the development-versus-delivery distinction|720](../06_Diagrams_&_Mindmaps/incremental_development_interleaving.png)
...
**هذي جملة مهمة:** التسليم التزايدي **مو فوضى** — فيه **تجميد موضعي**: **الزيادة الحالية مقفلة، واللاحقة مفتوحة**. **وهذا فرق دقيق عن التطوري** (الملف 03) اللي **ما يجمّد شي**.
