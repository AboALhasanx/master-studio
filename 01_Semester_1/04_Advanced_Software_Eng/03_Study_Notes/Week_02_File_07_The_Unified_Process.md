---
title: "ASE Week 02 — Unit 07: The Unified Process"
subtitle: "Putting it all together — four business-driven phases, nine workflows, and the one model that treats deployment as part of the process"
subject: "04_Advanced_Software_Eng"
week: 2
sources:

  - "Mall, Fundamentals of Software Engineering, 4th ed., §8.3.1, pp.475–476"

  - "Sommerville, Software Engineering, 9th ed., §2.4, pp.67–70"
...
![The Unified Process: four business-driven phases across nine workflows, with effort intensity shown as shading, the second level of iteration, the six best practices, and the Elaboration disagreement|720](../06_Diagrams_&_Mindmaps/unified_process_phases_workflows.png)
...
> **Answer:** Not for all development types — e.g., **embedded software development**. [Sommerville p.70 — Mall does not state this]
