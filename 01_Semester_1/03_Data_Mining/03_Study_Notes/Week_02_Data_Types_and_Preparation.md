> ⚠️ **REDIRECT — اقرأ هذا أولاً:** الدكتور يمتحن على تصنيف **Aggarwal (الفصل 2)** — العائلتان Nondependency / Dependency والـ 8 أنواع تحتها. القسم 3 بهالملف يستخدم تصنيف **Han & Kamber** (قائمة 8 هياكل مختلفة) وهو **ليس** ما يسأل عنه الدكتور. الملاحظة المصححة والمحاذاة مع مصدر الدكتور هي:
> 👉 `Week_02_03_DeepDive_Research_Reading.md` (قراءة بحثية عميقة بأسلوب "وزع-بحث" الدكتور، فيها بطاقة بحث لكل مصطلح + قسم مفصل عن Converting Different Data Types into a Graph).
> هذا الملف لا يزال مفيداً كمرجع إجرائي لتجهيز البيانات، لكن راجع التصنيف من الملف الجديد.
