# قراءة بحثية عميقة — محاضرة 2 و 3: أنواع البيانات وقابلية النقل (النسخة v4.1)

> **ملاحظة مهمة قبل تبدأ:** الدكتور ما يعلم — هو **يوزع بحث**. في هالنسخة v4.1، كل اقتباس إنكليزي معلَّم بـ `Wn Px` (الملزمة n، الصفحة x) هو **حرفياً من كلام الدكتور** بالمصادر (ملفات الـ docx الأصلية) — ما انجم من راسي. تحته مباشرة الشرح العربي الفهمي. باقي الملزمة كله عربي (والمصطلحات الإنكليزية كما هي بالمحاضرة).
>
